...
class StyleDirector:
    ...
    def _build_v2_messages(self, state: GraphState) -> list[dict]:
        ...
        system = (
            ...
            "It must contain a memorable visual idea that the layout agent can "
            "execute in HTML/CSS: for example oversized cropped typography, "
            "split-field composition, paper or print texture, modular grid, "
            "cutout collage, symbolic geometry, frame system, or kinetic diagonal "
            "structure. Avoid a plain gradient with centered text as the default. "
            "Use risk_level='expressive' or 'experimental' when the prompt allows "
            "a more distinctive poster.\n\n"
