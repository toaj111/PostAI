...
class Settings:
    ...
    llm_raw_max_tokens: int = 8192
    llm_feedback_context_chars: int = 6000
    llm_timeout_seconds: float = 90
    llm_raw_timeout_seconds: float = 180
    ...
    vision_html_context_chars: int = 12000
...
def get_settings() -> Settings:
    return Settings(
        ...
        llm_raw_max_tokens=_env_int("LLM_RAW_MAX_TOKENS", 8192),
        llm_feedback_context_chars=_env_int("LLM_FEEDBACK_CONTEXT_CHARS", 6000),
        llm_timeout_seconds=float(os.getenv("LLM_TIMEOUT_SECONDS", "90")),
        llm_raw_timeout_seconds=float(os.getenv("LLM_RAW_TIMEOUT_SECONDS", "180")),
        ...
        vision_thinking_budget=_env_int("VISION_THINKING_BUDGET", 8192),
        vision_max_tokens=_env_int("VISION_MAX_TOKENS", 4096),
        vision_html_context_chars=_env_int("VISION_HTML_CONTEXT_CHARS", 12000),
